...
export default function MediaServerList() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 720, display: "flex", flexDirection: "column", gap: 20 }}>
      <PageHeader
        title="Media Servers"
        description="Automatically refresh your media server library when an episode is imported."
          ...
          {items.length === 0 && !showAdd && (
            <div style={{ padding: 40, textAlign: "center", color: "var(--color-text-muted)", fontSize: 14 }}>
              ...
              <div style={{ fontSize: 12 }}>
                Add Plex, Emby, or Jellyfin to auto-refresh when episodes are imported.
              </div>
            </div>
          )}
        </div>
