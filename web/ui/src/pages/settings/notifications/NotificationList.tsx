    ...
    <>
      ...
      <div style={fieldStyle}>
        ...
        <input
          ...
          onFocus={focusBorder}
          onBlur={blurBorder}
          placeholder="screenarr@example.com"
        />
      </div>
      <div style={fieldStyle}>
...
export default function NotificationList() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900 }}>
      <PageHeader
        title="Notifications"
        description="Alerts for series events via Discord, Slack, Telegram, Gotify, ntfy, Pushover, and more."
        ...
        {isLoading ? (
          ...
          <div style={{ padding: 48, textAlign: "center" }}>
            ...
            <p style={{ margin: "6px 0 0", fontSize: 13, color: "var(--color-text-muted)" }}>
              Add alerts for series events via Discord, Telegram, Pushover, and more.
            </p>
          </div>
        ) : (
