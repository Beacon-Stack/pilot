...
function DownloadHandlingSection() {
  ...
  const defaultFormVal: DownloadHandling = {
  ...
  const [form, setForm] = useState<DownloadHandling>(defaultFormVal);
        ...
        {isLoading ? (
          ...
          <div style={{ padding: 48, textAlign: "center" }}>
            ...
            <p style={{ margin: "6px 0 0", fontSize: 13, color: "var(--color-text-muted)" }}>
              Add qBittorrent, Deluge, SABnzbd, or another client to start downloading.
            </p>
          </div>
        ) : (
