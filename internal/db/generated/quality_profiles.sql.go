...
RETURNING id, name, cutoff_json, qualities_json, upgrade_allowed, upgrade_until_json, min_custom_format_score, upgrade_until_cf_score, created_at, updated_at, managed_by_pulse
`
...
SELECT id, name, cutoff_json, qualities_json, upgrade_allowed, upgrade_until_json, min_custom_format_score, upgrade_until_cf_score, created_at, updated_at, managed_by_pulse FROM quality_profiles WHERE id = $1
`
...
SELECT id, name, cutoff_json, qualities_json, upgrade_allowed, upgrade_until_json, min_custom_format_score, upgrade_until_cf_score, created_at, updated_at, managed_by_pulse FROM quality_profiles WHERE managed_by_pulse = TRUE ORDER BY name ASC
`
...
SELECT id, name, cutoff_json, qualities_json, upgrade_allowed, upgrade_until_json, min_custom_format_score, upgrade_until_cf_score, created_at, updated_at, managed_by_pulse FROM quality_profiles ORDER BY name ASC
`
