...
RETURNING id, name, kind, enabled, settings, search_on_add, monitor, monitor_type, quality_profile_id, library_id, created_at, updated_at
`
...
SELECT id, name, kind, enabled, settings, search_on_add, monitor, monitor_type, quality_profile_id, library_id, created_at, updated_at FROM import_list_configs WHERE id = $1
`
...
SELECT id, name, kind, enabled, settings, search_on_add, monitor, monitor_type, quality_profile_id, library_id, created_at, updated_at FROM import_list_configs WHERE enabled = TRUE ORDER BY name ASC
`
...
SELECT id, name, kind, enabled, settings, search_on_add, monitor, monitor_type, quality_profile_id, library_id, created_at, updated_at FROM import_list_configs ORDER BY name ASC
`
