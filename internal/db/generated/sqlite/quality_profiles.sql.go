...
SELECT id, name, cutoff_json, qualities_json, upgrade_allowed, upgrade_until_json, min_custom_format_score, upgrade_until_cf_score, created_at, updated_at FROM quality_profiles WHERE id = ?
`
