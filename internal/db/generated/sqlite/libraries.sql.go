...
SELECT id, name, root_path, default_quality_profile_id, naming_format, folder_format, min_free_space_gb, tags_json, created_at, updated_at FROM libraries WHERE id = ?
`
