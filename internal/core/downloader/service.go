...
// cachedClient returns a cached or freshly-created download client for the
// given config. Cached clients persist across calls, avoiding repeated auth
// round-trips.
...
// protocol and submits the release. Returns the download client config ID and
