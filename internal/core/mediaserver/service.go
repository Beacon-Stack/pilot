...
func (s *Service) Create(ctx context.Context, req CreateRequest) (Config, error) {
	...
	row, err := s.q.CreateMediaServerConfig(ctx, db.CreateMediaServerConfigParams{
		ID:        uuid.New().String(),
		Name:      req.Name,
		Kind:      req.Kind,
		Enabled:   req.Enabled,
...
func (s *Service) Update(ctx context.Context, id string, req UpdateRequest) (Config, error) {
	...
	row, err := s.q.UpdateMediaServerConfig(ctx, db.UpdateMediaServerConfigParams{
		ID:        id,
		Name:      req.Name,
		Kind:      req.Kind,
		Enabled:   req.Enabled,
...
func rowToConfig(row db.MediaServerConfig) Config {
